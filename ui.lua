    ...
    local Lotus = Instance.new("ScreenGui")
    ...
    function LotusLib:Window(Win)
        if _Lotus == "LotusHubOnTop" then
            local ScriptName;
            ...
            local function ripple(button, x, y)
                spawn(
                    function()
                        ...
                        circle.ZIndex = 1000
                        circle.ImageColor3 = LotusLib.Themes[Theme].TitleBar
            ...
            Lotus.Name = "Lotus"		
            Lotus.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
            Lotus.ResetOnSpawn = false
            Lotus.Parent = game:GetService("CoreGui")
    
            Main.Name = "Main"
            Main.Parent = Lotus
            Main.BackgroundColor3 = LotusLib.Themes[Theme].Main
            ...
            if OnPc or OnTabletLaptop then
                Main.Position = LotusLib.Elements.WideMenu.MainPosition
                Main.Size = LotusLib.Elements.WideMenu.MainSize
            end
    
            UICorner.Parent = Main
    
            UIStroke.Parent = Main
            UIStroke.Color = LotusLib.Themes[Theme].Shadow
            UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    
            TitleBar.Name = "TitleBar"
            TitleBar.Parent = Main
            TitleBar.BackgroundColor3 = LotusLib.Themes[Theme].TitleBar
            TitleBar.BorderColor3 = LotusLib.Themes[Theme].TitleBar
            TitleBar.BorderSizePixel = 0
            TitleBar.Size = UDim2.new(0, 592, 0, 33)
    
            if OnPc or OnTabletLaptop then
                TitleBar.Size = LotusLib.Elements.WideMenu.TitleBarSize
            end
            ...
            BarFixer.BackgroundColor3 = LotusLib.Themes[Theme].TitleBar
            BarFixer.BorderColor3 = LotusLib.Themes[Theme].TitleBar
            ...
            Line.BackgroundColor3 = LotusLib.Themes[Theme].TitleLineColor
            Line.BorderColor3 = LotusLib.Themes[Theme].TitleLineColor
            ...
            Close.Text = "X"
            Close.TextColor3 = LotusLib.Themes[Theme].CloseMinimize
            Close.TextSize = 18.000
            Close.Visible = false
    
            if OnPc or OnTabletLaptop then
                Close.Position = LotusLib.Elements.WideMenu.ClosePosition
            end
            ...
            Minimize.Text = "-"
            Minimize.TextColor3 = LotusLib.Themes[Theme].CloseMinimize
            Minimize.TextSize = 34.000
            Minimize.Visible = false
    
            if OnPc or OnTabletLaptop then
                Minimize.Position = LotusLib.Elements.WideMenu.MinimizePosition
            end
            ...
            Title.TextColor3 = LotusLib.Themes[Theme].TitleTextColor
            Title.TextSize = 16.000
            Title.TextXAlignment = Enum.TextXAlignment.Left
    
            if OnPc or OnTabletLaptop then
                Title.Position = LotusLib.Elements.WideMenu.TitlePosition
            end
            ...
            if OnPc or OnTabletLaptop then
                Tabs.Size = LotusLib.Elements.WideMenu.TabsSize
                Tabs.Position = LotusLib.Elements.WideMenu.TabPosition
            end
            ...
            if OnPc or OnTabletLaptop then
                Pages.Position = LotusLib.Elements.WideMenu.PagesPosition
                Pages.Size = LotusLib.Elements.WideMenu.PagesSize
            end
    
            Shadow.Name = "Shadow"
            Shadow.Parent = Main
            Shadow.Active = true
            Shadow.BackgroundColor3 = LotusLib.Themes[Theme].Shadow
            Shadow.BackgroundTransparency = 1.000
            Shadow.Position = UDim2.new(0, -15, 0, -12)
            Shadow.Size = UDim2.new(1, 30, 0.983647227, 30)
            Shadow.ZIndex = 0
            Shadow.Image = "rbxassetid://5028857084"
            Shadow.ImageColor3 = LotusLib.Themes[Theme].Shadow
            Shadow.ScaleType = Enum.ScaleType.Slice
            Shadow.SliceCenter = Rect.new(24, 24, 276, 276)
    
            function LotusLib:ToggleUI()	
                for i, v in pairs(game:GetService("CoreGui"):GetChildren()) do
                    if v.Name == "Lotus" then
                    ...
                    if visibility == true then
                        ...
                        if openbutton ~= nil then
                            if openbutton == true then
                                ...
                                OpenFrame.Parent = Lotus
                                OpenFrame.Active = true
                                OpenFrame.BackgroundColor3 = LotusLib.Themes[Theme].TitleBar
                                ...
                                Open.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                                Open.Size = UDim2.new(1.0, 0, 0.92, 0)
                                Open.Font = Enum.Font.GothamBold
                                Open.Text = "Open"
                                Open.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
            ...
            function Sayfalar:Tab(TabName, PageTitle)
                ...
                TabBtnFrame.BackgroundColor3 = LotusLib.Themes[Theme].TabBefore
                TabBtnFrame.BorderColor3 = LotusLib.Themes[Theme].TabBefore
                ...
                Selected.BackgroundColor3 = LotusLib.Themes[Theme].Selection
                Selected.BackgroundTransparency = 1
                Selected.BorderColor3 = LotusLib.Themes[Theme].Selection
                ...
                TabText.TextColor3 = LotusLib.Themes[Theme].TabTextColor
                ...
                if OnPc or OnTabletLaptop then
                    Page.Size = LotusLib.Elements.WideMenu.PageSize
                    Page.Position = LotusLib.Elements.WideMenu.PagePosition
                end
                ...
                PageTitle.TextColor3 = LotusLib.Themes[Theme].PageTitleColor
                PageTitle.TextSize = 25.000
                PageTitle.TextXAlignment = Enum.TextXAlignment.Left
    
                if OnPc or OnTabletLaptop then
                    PageTitle.Size = LotusLib.Elements.WideMenu.SectionSize
                end
                ...
                if FirstTab == false then
                    ...
                    TabBtnFrame.BackgroundColor3 = LotusLib.Themes[Theme].TabAfter
                    TabBtnFrame.BorderColor3 = LotusLib.Themes[Theme].TabAfter
                    Page.Visible = true
                end
                ...
                TabText.MouseButton1Click:Connect(function()
                    ...
                    for i, v in pairs(Tabs:GetChildren()) do
                        if v:IsA("Frame") then
                            TweenService:Create(v, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundColor3 = LotusLib.Themes[Theme].TabBefore}):Play()
                            TweenService:Create(v.Selected, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 1}):Play()
                        end
                    end
                    TweenService:Create(TabBtnFrame, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundColor3 = LotusLib.Themes[Theme].TabAfter}):Play()
                ...
                function ContainerItems:Section(Title)
                    ...
                    if x ~= nil then
                        ...
                        if OnPc or OnTabletLaptop then
                            Section.Size = LotusLib.Elements.WideMenu.SectionSize
                        end
                        ...
                        Sektion.TextColor3 = LotusLib.Themes[Theme].PageTitleColor
                        Sektion.TextSize = 20
                        ...
                        function SectionItems:Label(title, description)
                            ...
                            Label.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            Label.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            LabelListing.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            LabelListing.BackgroundTransparency = 1.000
                            LabelListing.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            LabelMainText.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                            ...
                            LabelText.TextColor3 = LotusLib.Themes[Theme].ItemTextColors
                        ...
                        function SectionItems:Button(yazi, description, callback)
                            ...
                            Button.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            Button.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            ButtonTitle.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                            ...
                            ButtonText.TextColor3 = LotusLib.Themes[Theme].ItemTextColors
                            ...
                            ClickIcon.ImageColor3 = LotusLib.Themes[Theme].ButtonClickIconColor
                            ...
                            Button.MouseEnter:Connect(
                                function()
                                    TweenService:Create(
                                        Button,
                                        TweenInfo.new(.2, Enum.EasingStyle.Quad),
                                        {BackgroundColor3 = LotusLib.Themes[Theme].ButtonHover}
                                    ):Play()
                                end
                            )
                            Button.MouseLeave:Connect(
                                function()
                                    TweenService:Create(
                                        Button,
                                        TweenInfo.new(.2, Enum.EasingStyle.Quad),
                                        {BackgroundColor3 = LotusLib.Themes[Theme].ItemColors}
                                    ):Play()
                                end
                            )
                        ...
                        function SectionItems:Paragraph(pharagraphtitle, description)
                            ...
                            Pharagraph.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            Pharagraph.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            PharagraphTitle.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                            ...
                            for i, v in pairs(desc) do
                                ...
                                PharagraphText.TextColor3 = LotusLib.Themes[Theme].ItemTextColors
                        ...
                        function SectionItems:Slider(Text, minvalue, maxvalue, callback)
                            ...
                            Slider.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            Slider.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            SliderTitle.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                            ...
                            SliderButtonFrame.BackgroundColor3 = LotusLib.Themes[Theme].SliderButtonFrameColor
                            SliderButtonFrame.BorderColor3 = LotusLib.Themes[Theme].SliderButtonFrameColor
                            ...
                            SliderButton.BackgroundColor3 = LotusLib.Themes[Theme].SliderButtonFrameColor
                            SliderButton.BackgroundTransparency = 1.000
                            SliderButton.BorderColor3 = LotusLib.Themes[Theme].SliderButtonFrameColor
                            ...
                            SliderFixer.BackgroundColor3 = LotusLib.Themes[Theme].SliderButtonFrameColor
                            SliderFixer.BackgroundTransparency = 1.000
                            SliderFixer.BorderColor3 = LotusLib.Themes[Theme].SliderButtonFrameColor
                            SliderFixer.BorderSizePixel = 0
                            SliderFixer.Size = UDim2.new(1, 0, 1, 0)
                            SliderFixer.ScrollBarImageColor3 = LotusLib.Themes[Theme].SliderButtonFrameColor
                            ...
                            UIGradient.Color = LotusLib.Themes[Theme].InSliderFrame
                            ...
                            Num.TextColor3 = LotusLib.Themes[Theme].NumColor
                            Num.TextSize = 14.000
                        ...
                        function SectionItems:Line()
                            ...
                            Line.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                        ...
                        function SectionItems:ColorPicker(text, preset, callback)
                            ...
                            Colorpicker.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            Title.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                            ...
                            ColorpickerFrame.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            Confirm.BackgroundColor3 = LotusLib.Themes[Theme].TitleBar
                            ...
                            Confirm.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                            ...
                            RainbowToggle.BackgroundColor3 = LotusLib.Themes[Theme].TitleBar
                            ...
                            RainbowTitle.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                            ...
                            RainbowToggleFrame.BackgroundColor3 = LotusLib.Themes[Theme].Main
                        ...
                        function SectionItems:KeyBind(keytext, first, callback)
                            ...
                            KeyBind.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            KeyBind.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            KeyBindTitle.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                            KeyBindTitle.TextSize = 15.000
                            KeyBindTitle.TextXAlignment = Enum.TextXAlignment.Left
    
                            BindSelection.Name = "BindSelection"
                            BindSelection.Parent = KeyBind
                            BindSelection.BackgroundColor3 = LotusLib.Themes[Theme].ItemTextBoxKeyBindColors
                            BindSelection.BorderColor3 = LotusLib.Themes[Theme].ItemTextBoxKeyBindColors
                            ...
                            UIStroke_9.Color = LotusLib.Themes[Theme].ItemTextBoxKeyBindStrokeColors
                            ...
                            Bind.Text = first
                            Bind.TextColor3 = LotusLib.Themes[Theme].ItemKeyBindTextColor
                        ...
                        function SectionItems:Toggle(TexT, check, callback)
                            ...
                            ToggleFrame.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ToggleFrame.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ToggleFrame.Position = UDim2.new(0.0196850393, 0, 0.637992859, 0)
                            ToggleFrame.Size = UDim2.new(0, 391, 0, 44)
    
                            Toggle.Name = "Toggle"
                            Toggle.Parent = ToggleFrame
                            Toggle.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            Toggle.BackgroundTransparency = 1.000
                            Toggle.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            ToggleText.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ToggleText.BackgroundTransparency = 1.000
                            ToggleText.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ToggleText.Position = UDim2.new(0.031, 0,0.275, 0)
                            ToggleText.Size = UDim2.new(0, 121, 0, 22)
                            ToggleText.Font = Enum.Font.GothamBold
                            ToggleText.Text = TexT
                            ToggleText.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                            ...
                            ToggleIconer.BackgroundColor3 = LotusLib.Themes[Theme].ItemTextBoxKeyBindColors
                            ToggleIconer.BorderColor3 = LotusLib.Themes[Theme].ItemTextBoxKeyBindColors
                            ...
                            UIStroke.Color = LotusLib.Themes[Theme].ItemTextBoxKeyBindStrokeColors
                            UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    
                            done.Name = "done"
                            done.Parent = ToggleIconer
                            done.BackgroundColor3 = LotusLib.Themes[Theme].ItemTextBoxKeyBindColors
                            done.BorderColor3 = LotusLib.Themes[Theme].ItemTextBoxKeyBindColors
                            ...
                            done.ImageColor3 = LotusLib.Themes[Theme].ToggleTickColor
                        ...
                        function SectionItems:TextBox(TexT, Desc, callback)
                            ...
                            TextBox.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            TextBox.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            TexttingBox.BackgroundColor3 = LotusLib.Themes[Theme].ItemTextBoxKeyBindColors
                            TexttingBox.BorderColor3 = LotusLib.Themes[Theme].ItemTextBoxKeyBindColors
                            ...
                            TexttingBox.PlaceholderColor3 = LotusLib.Themes[Theme].ItemTextBoxTextColor
                            TexttingBox.PlaceholderText = Desc
                            TexttingBox.Text = ""
                            TexttingBox.TextColor3 = LotusLib.Themes[Theme].ItemTextBoxTextColor
                            ...
                            UIStroke_4.Color = LotusLib.Themes[Theme].ItemTextBoxKeyBindStrokeColors
                            UIStroke_4.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    
                            TextBoxTitle.Name = "TextBoxTitle"
                            TextBoxTitle.Parent = TextBox
                            TextBoxTitle.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            TextBoxTitle.BackgroundTransparency = 1.000
                            TextBoxTitle.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            TextBoxTitle.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                        ...
                        function SectionItems:Dropdown(teks, list, callback)
                            ...
                            Dropdown.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            Title.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            Title.BackgroundTransparency = 1.000
                            ...
                            Arrow.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            Arrow.BackgroundTransparency = 1.000
                            Arrow.Position = UDim2.new(0.913561523, 0, 0.211111104, 0)
                            Arrow.Size = UDim2.new(0, 26, 0, 27)
                            Arrow.Image = "rbxassetid://6034818372"
                            Arrow.ImageColor3 = LotusLib.Themes[Theme].ItemTitleColors
    
                            DropdownFrame.Name = "DropdownFrame"
                            DropdownFrame.Parent = Container
                            DropdownFrame.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            DropdownHolder.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            DropdownHolder.ScrollBarImageColor3 = LotusLib.Themes[Theme].TitleBar
                        ...
                        function SectionItems:Image(title, writeinto, Expander)
                            ...
                            Image.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            Image.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            ImageTitle.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ImageTitle.BackgroundTransparency = 1.000
                            ImageTitle.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            ImageTitle.TextColor3 = LotusLib.Themes[Theme].ItemTitleColors
                            ImageTitle.TextSize = 15.000
                            ImageTitle.TextXAlignment = Enum.TextXAlignment.Left
    
                            ImageButton.Name = "ImageButton"
                            ImageButton.Parent = Image
                            ImageButton.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ImageButton.BackgroundTransparency = 1.000
                            ImageButton.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            ImageFrame.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ImageFrame.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            if string.find(imagelink, "rbxassetid") then
                                ...
                                ImageLabel.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                                ImageLabel.BackgroundTransparency = 1.000
                                ImageLabel.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            elseif string.find(imagelink, "https") then			
                                ...
                                VideoLabel.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                                VideoLabel.BackgroundTransparency = 1.000
                                VideoLabel.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            ImageListing.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ImageListing.BackgroundTransparency = 1.000
                            ImageListing.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ...
                            ButtonTitle.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                            ButtonTitle.BackgroundTransparency = 1.000
                            ButtonTitle.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                            ButtonTitle.BorderSizePixel = 0
                            ButtonTitle.Size = UDim2.new(0, 379, 0, 17)
                            ButtonTitle.Font = Enum.Font.GothamBold
                            ...
                            for i, v in next, description do
                                ...
                                ButtonText.BackgroundColor3 = LotusLib.Themes[Theme].ItemColors
                                ButtonText.BackgroundTransparency = 1.000
                                ButtonText.BorderColor3 = LotusLib.Themes[Theme].ItemColors
                                ButtonText.BorderSizePixel = 0
                                ButtonText.Position = UDim2.new(0, 0, 0.170000002, 0)
                                ButtonText.Size = UDim2.new(0, 379, 0, 17)
                                ButtonText.Font = Enum.Font.Gotham
    ...
    function LotusLib:AddNotifications()
        if _Lotus == "ohhahtuhthttouttpwuttuaunbotwo" then
            ...
            local LotusNotifications = Lotus
    
            NotifyListing.Name = "NotifyListing"
            NotifyListing.Parent = LotusNotifications
            ...
            NotificationListing.Parent = LotusNotifications
            ...
            function NotificationItems:Notification(Title, Text, Selector, Cooldowm)
                ...
                notification.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                notification.BackgroundTransparency = 1.000
                notification.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                ...
                notificationcontainer.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                notificationcontainer.BackgroundTransparency = 0.200
                notificationcontainer.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                ...
                Listing_2.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                Listing_2.BackgroundTransparency = 1.000
                Listing_2.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                ...
                LabelMainText_2.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                LabelMainText_2.BackgroundTransparency = 1.000
                LabelMainText_2.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                ...
                LabelMainText_2.TextColor3 = LotusLib.Themes[theme].NotificationNotifyTitleColor
                ...
                LabelText_2.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                LabelText_2.BackgroundTransparency = 1.000
                LabelText_2.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                ...
                LabelText_2.TextColor3 = LotusLib.Themes[theme].NotificationNotifyTextColor
                LabelText_2.TextSize = 15.000
                LabelText_2.TextStrokeColor3 = LotusLib.Themes[theme].NotificationNotifyTextColor
                ...
                Shadow_2.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                ...
                Shadow_2.ImageColor3 = LotusLib.Themes[theme].IconShadow
                Shadow_2.ScaleType = Enum.ScaleType.Slice
                Shadow_2.SliceCenter = Rect.new(24, 24, 276, 276)
    
                Icon_2.Name = "Icon"
                Icon_2.Parent = IconFrame_2
                Icon_2.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                Icon_2.BackgroundTransparency = 1.000
                Icon_2.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                ...
                Icon_2.ImageColor3 = LotusLib.Themes[theme].IconColor			
    
                UIStroke_2.Parent = notificationcontainer
                UIStroke_2.Color = LotusLib.Themes[theme].NotifyButtons
            ...
            function NotificationItems:Notify(title, text, Selector, callback)			
                ...
                notify.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                notify.BackgroundTransparency = 1.000
                notify.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                ...
                notifycontainer.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                notifycontainer.BackgroundTransparency = 0.200
                notifycontainer.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                ...
                Listing.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                Listing.BackgroundTransparency = 1.000
                Listing.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                ...
                LabelMainText.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                LabelMainText.BackgroundTransparency = 1.000
                LabelMainText.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                LabelMainText.BorderSizePixel = 0
                LabelMainText.Position = UDim2.new(-0.161290318, 0, 0.4375, 0)
                LabelMainText.Size = UDim2.new(0, 232, 0, 17)
                LabelMainText.Font = Enum.Font.GothamBold
                LabelMainText.Text = title
                LabelMainText.TextColor3 = LotusLib.Themes[theme].NotificationNotifyTitleColor
                LabelMainText.TextSize = 15.000
                LabelMainText.TextXAlignment = Enum.TextXAlignment.Left
    
                LabelText.Name = "LabelText"
                LabelText.Parent = Listing
                LabelText.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                LabelText.BackgroundTransparency = 1.000
                LabelText.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                LabelText.BorderSizePixel = 0
                LabelText.Position = UDim2.new(-0.0497237556, 0, -1.7428571, 0)
                LabelText.Size = UDim2.new(0, 162, 0, 17)
                LabelText.Font = Enum.Font.Gotham
                LabelText.Text = text
                LabelText.TextColor3 = LotusLib.Themes[theme].NotificationNotifyTextColor
                LabelText.TextSize = 15.000
                LabelText.TextXAlignment = Enum.TextXAlignment.Left
                ...
                Shadow.Active = true
                Shadow.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                Shadow.BackgroundTransparency = 1.000
                Shadow.Position = UDim2.new(0, -15, 0, -15)
                Shadow.Size = UDim2.new(1, 30, 1, 30)
                Shadow.ZIndex = 0
                Shadow.Image = "rbxassetid://5028857084"
                Shadow.ImageColor3 = LotusLib.Themes[theme].IconShadow
                Shadow.ScaleType = Enum.ScaleType.Slice
                Shadow.SliceCenter = Rect.new(24, 24, 276, 276)
    
                Icon.Name = "Icon"
                Icon.Parent = IconFrame
                Icon.BackgroundColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                Icon.BackgroundTransparency = 1.000
                Icon.BorderColor3 = LotusLib.Themes[theme].NotificationNotifyColor
                Icon.Position = UDim2.new(0.159283891, 0, 0.179691225, 0)
                Icon.Size = UDim2.new(0, 26, 0, 26)
                Icon.Image = "http://www.roblox.com/asset/?id=7021995683"
                Icon.ImageColor3 = LotusLib.Themes[theme].IconColor
    
                UIStroke.Parent = notifycontainer
                UIStroke.Color = LotusLib.Themes[theme].NotifyButtons
                UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                ...
                clear.ImageColor3 = LotusLib.Themes[theme].NotifyButtons
                ...
                done.ImageColor3 = LotusLib.Themes[theme].NotifyButtons
                done.ImageRectOffset = Vector2.new(644, 204)
                done.ImageRectSize = Vector2.new(36, 36)
